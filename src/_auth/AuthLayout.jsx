...
const AuthLayout = () => {
  ...
  const cardSetting = clickedSignUp ? {scale: 1} : {scale: 0};
      ...
      {isAuthenticated ? (
        ...
        <div className='w-full h-full relative'>
          <section className='flex w-full h-full justify-end'>
            ...
            <motion.div style={{position: 'absolute', bottom: "50px", left: "28%", width: "600px", height: "90%", background: "white", borderRadius: "5%"}} className='custom-scrollbar z-20'
